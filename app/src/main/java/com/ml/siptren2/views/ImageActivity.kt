...
import com.ml.siptren2.BuildConfig
...
class ImageActivity : AppCompatActivity() {
    ...
    private lateinit var tombolfoto: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageView = findViewById(R.id.contoh_img)
        tombolfoto = findViewById(R.id.contoh_foto)
        tombolsimpan = findViewById(R.id.contoh_simpan)
